...
This folder contains a Postman Collection that contains the requests used in the [Design Automation for Inventor Step-by-Step tutorial](https://forge.autodesk.com/en/docs/design-automation/v3/tutorials/inventor/) on the APS developer portal. 
...
![APS developer portal menu to Postman](images/forge_portal_2_inventor_postman_menu_01.png "APS developer portal task to Postman mapping")

Individual requests in Postman have the same names as the corresponding step in the APS developer portal.

![APS developer portal steps to Postman](images/forge_portal_2_inventor_postman_menu_02.png "APS developer portal task to Postman mapping")
